...
const postData = [
  {
    ...
    content: 'MVC allows developers to maintain a true separation of concern, devising their code between the Model layer for data, the View layer for design, and the Controller layer for application logic.',
    user_id: 1
